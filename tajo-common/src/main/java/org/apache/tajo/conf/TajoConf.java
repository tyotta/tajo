...
public class TajoConf extends Configuration {
  ...
  public static enum ConfVars implements ConfigKey {
    ...
    YARN_RM_TASKRUNNER_LAUNCH_PARALLEL_NUM("tajo.yarn-rm.parallel-task-runner-launcher-num",  Runtime.getRuntime().availableProcessors()),
    ...
    // Seungun Choe fixed start
    TUPLE_SLOT_SIZE("tajo.tuple.slot.size",10000),
    // Seungun Choe fixed end
