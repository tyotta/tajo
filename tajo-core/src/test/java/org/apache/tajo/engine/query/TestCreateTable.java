...
public class TestCreateTable extends QueryTestCaseBase {
  ...
  @Test
  public final void testTableWithHeaderLine() throws Exception {
    List<String> tableNames = null;
    tableNames = executeDDL("table_with_header_line.sql", "tableWithHeaderLine");
    assertTableExists(tableNames.get(0));
    ResultSet res = null;
    try {
      res = executeFile("skip_header_line.sql");
      assertResultSet(res, "skip_header_line.result");
    } finally {
      cleanupQuery(res);
    }
  ...
  @Test
  public final void testTableWithRegexFormatter() throws Exception {
    List<String> tableNames = null;
    tableNames = executeDDL("create_table_with_regex_formatter.sql", "tableWithRegexFormatter");
    assertTableExists(tableNames.get(0));
    ResultSet res = null;
    try {
      res = executeFile("table_with_regex_formatter.sql");
      assertResultSet(res, "table_with_regex_formatter.result");
    } finally {
      cleanupQuery(res);
    }
    executeString("drop table " + tableNames.get(0)).close();
  ...
  @Test
  public final void testTableWithLineDelimiter() throws Exception {
    List<String> tableNames = null;
    tableNames = executeDDL("create_table_with_line_delimiter.sql", "tableWithLineDelimiter");
    assertTableExists(tableNames.get(0));
    ResultSet res = null;
    try {
      res = executeFile("table_with_line_delimiter.sql");
      assertResultSet(res, "table_with_line_delimiter.result");
    } finally {
      cleanupQuery(res);
    }
    executeString("drop table " + tableNames.get(0)).close();
